<template>
  <section class="tool-category-section" id="code-tools" v-show="filteredTools.length > 0">
    <header class="section-header">
      <h2 class="section-title">💻 AI代码工具</h2>
...
const filteredTools = computed(() => {
  if (!props.searchKeyword.trim()) return codeTools;
  const keyword = props.searchKeyword.toLowerCase();
  return codeTools.filter(tool => 
