<template>
  <section class="tool-category-section" id="text-tools" v-show="filteredTools.length > 0">
    <header class="section-header">
      <h2 class="section-title">📝 AI文本工具</h2>
...
const filteredTools = computed(() => {
  if (!props.searchKeyword.trim()) return textTools;
